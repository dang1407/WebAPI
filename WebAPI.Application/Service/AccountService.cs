...
{
    public class AccountService : BaseCompanyService<Account, AccountDTO, AccountCreateDTO, AccountUpdateDTO>, IAccountService
    {
        private readonly IUserRepository _userRepository;   
        public AccountService(IUserRepository userRepository, IMapper mapper) : base(userRepository, mapper)
        {  
