...
{
    public interface IBaseCompanyService<TDTO, TCreateDTO, TUpdateDTO> : IBaseCompanyReadOnlyService<TDTO>
    {
        /// <summary>
        ...
        Task<TDTO> InsertAsync( TCreateDTO createDTO, Guid companyId);
        ...
        /// Created by: nkmdang (20/09/2023)
        Task<List<TDTO>> InsertManyAsync(List<TCreateDTO> createDTOs, Guid companyId);
        ...
        /// Created by: nkmdang (20/09/2023)
        Task<TDTO> UpdateAsync(Guid id, TUpdateDTO updateDTO, Guid companyId);
        ...
        /// <returns>Số bản ghi đã xóa</returns>
        /// Created by: nkmdang (20/09/2023)
        Task<int> DeleteManyAsync(List<Guid> ids, Guid companyId);
    }
}
